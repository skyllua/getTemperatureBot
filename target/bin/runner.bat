...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="runner" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.example.Runner %CMD_LINE_ARGS%
